...
} = require("./my_db.helper");

const joi_get_messages_list = () => {
  return {
...
const joi_get_default_validate_options = () => {
  return {
    abortEarly: false,
    stripUnknown: true,
...
const joi_custom_is_mongodb_objectid = (_value, _helpers) => {
  return !is_mongodb_objectid(_value) ? _helpers.error("any.invalid") : _value;
};

module.exports.my_joi = {
